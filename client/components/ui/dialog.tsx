...
function DialogOverlay({ className, overlayBlur = true, ...props }: React.ComponentProps<typeof DialogPrimitive.Overlay> & { overlayBlur?: boolean }) {
  return (
    <DialogPrimitive.Overlay
      data-slot="dialog-overlay"
      className={cn(
        overlayBlur ? "bg-black/10 supports-backdrop-filter:backdrop-blur-xs" : "",
